...
filenmparams = 'Run results\\criticality_run_bigtrain_part3_params.pkl'
filenmoutput = 'Run results\\criticality_run_bigtrain_part3_output.pkl'
...
file_load = 'Run results\\criticality_run1.pkl'
...
param_space = param_space[300:500]
#
...
num_iter = 200     #number of iterations to do in the algorithm! ~ stopping criterion

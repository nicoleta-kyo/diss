...
## !!!!!!!! stopped at 117 in order to run Jupyter Notebook
...
from criticality_algo_functions_withsave import det_criticality

#=================== Params
    
# filename for run if to save!!!!!!!!!!
filenmparams = 'Run results\\criticality_run_newnarma_part2_params.pkl'
filenmoutput = 'Run results\\criticality_run_newnarma_part2_output2.pkl'
...
narma_params = config_run1['narma_params']
...
param_space = param_space[618:750]
#
...
num_iter = 133     #number of iterations to do in the algorithm! ~ stopping criterion
...
run_objects['narma_params'] = narma_params
...
det_criticality(esn_config, narma_in, narma_out, param_space, num_iter, num_trials, num_pert, sigma_p, filenmoutput)
#determinants, crit_params = det_criticality(esn_config, narma_in, narma_out, param_space, num_iter, num_trials, num_pert, sigma_p, filenmoutput)

...
filenm = 'Results\\criticality_run_radius1_part3.pkl'
...
param_space = param_space[700:801]
#
...
num_iter = 100     #number of iterations to do in the algorithm! ~ stopping criterion

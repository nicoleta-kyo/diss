...
#         pdb.set_trace()
    ...
    def connectToEnv(self, states, max_cost, goal_state):
        self.env = LettersEnv(states, max_cost, goal_state)
        self.maxobs = self.env.num_st
...
#         pdb.set_trace()
    ...
    def SarsaLearning(self, total_episodes, max_steps, Beta=None, gamma=None, lr=None):

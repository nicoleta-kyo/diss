...
filenmparams = 'Run results\\criticality_run_bigtrain_part5_params.pkl'
filenmoutput = 'Run results\\criticality_run_bigtrain_part5_output.pkl'
...
num_iter = 300     #number of iterations to do in the algorithm! ~ stopping criterion

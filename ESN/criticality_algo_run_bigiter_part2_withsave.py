...
filenmparams = 'criticality_run_bigiter_part2_params.pkl'
filenmoutput = 'criticality_run_bigiter_part2_output.pkl'
...
param_space = param_space[250:500]



# =================== For number of runs

num_iter = 250     #number of iterations to do in the algorithm! ~ stopping criterion

...
filenm = 'Results\\criticality_run_radius1_part4.pkl'
...
file_load = 'Results\\criticality_run1.pkl'
...
param_space = np.concatenate((param_space, np.array([[0,0,0]])))

param_space = param_space[800:]
#

...
filenmparams = 'Run results\\criticality_run_bigtrain_part2_params.pkl'
filenmoutput = 'Run results\\criticality_run_bigtrain_part2_output.pkl'
...
param_space = param_space[100:300]
#

...
filenmparams = 'Run results\\criticality_run_bigtrain_part4_params.pkl'
filenmoutput = 'Run results\\criticality_run_bigtrain_part4_output.pkl'
...
param_space = param_space[500:700]
#

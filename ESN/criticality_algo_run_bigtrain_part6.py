...
filenmparams = 'Run results\\criticality_run_bigtrain_part6_params.pkl'
filenmoutput = 'Run results\\criticality_run_bigtrain_part6_output.pkl'
...
num_iter = 120     #number of iterations to do in the algorithm! ~ stopping criterion

...
# filename for run without the folder because it will be run on monty's oc
filenmparams = 'criticality_run_bigiter_part3_params.pkl'
filenmoutput = 'criticality_run_bigiter_part3_output.pkl'
...
# params for narma
narma_params = {}
narma_params['order'] = 10
narma_params['size'] = 1200
narma_params['coef_u'] = 1.5
narma_params['lb_input'] = 0
narma_params['ub_input'] = 0.5
...
num_iter = 500     #number of iterations to do in the algorithm! ~ stopping criterion
